...
func _do_fetch(URL: String, headers:PackedStringArray, callback: Callable , method := HTTPClient.METHOD_GET, body : String = "") -> String:
	if URL == null or URL == "" : return "NO URL"
	if callback == null : return "NO CALLBACK"
